...
export const SUPPORT_EMAIL = "store.quadrus@gmail.com";
...
export const META_DEFAULTS = {
  custom: [],
  description:
    "Quadrus PWA storefront built with Saleor's e-commerce GraphQL API. Written with React and TypeScript.",
  image: `${window.location.origin}${require("../images/logo.svg")}`,
  title: "Quadrus Commerce",
  type: "website",
